            ...
            "subSections": [
                {
                    ...
                    "topics": [
                        ...
                        },
                        {
                            ...
                            "noteType": "PracticeSet",
                            "topicId": 249,
                            "description": "<p><span style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">1️⃣ Can you tell me how a router works?</span></p><p><span style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">2️⃣ </span>How can you <strong>optimize Angular Application</strong> for <strong>better performance</strong>?</p><p><span style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">3️⃣ </span>If on a <strong>button click</strong> I hit an <strong>API</strong> and the <strong>API takes 2 minutes</strong> and I keep clicking the button, then when I get a <strong>response</strong>, how can I <strong>cancel all other API calls</strong>?</p><p><span style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">4️⃣ </span>What is the role of a <strong>compiler</strong> in <strong>Angular</strong>?</p><p><span style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">5️⃣ </span>How do <strong>components communicate</strong> with each other in a <strong>large-scale Angular application</strong>?</p><p><span style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">6️⃣ </span>Create a <strong>registration form</strong> with fields: <strong>name</strong>, <strong>email</strong>, <strong>password</strong>, and <strong>confirmPassword</strong>. Apply <strong>validations</strong> for <strong>required fields</strong>, and ensure <strong>password</strong> and <strong>confirmPassword match</strong>. How will you do it in <strong>Angular</strong>?</p><p><span style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">7️⃣ </span>If I need to <strong>filter some item</strong> at every <strong>keystroke</strong> of user, how can we implement with <strong>Event binding approach</strong>?</p><p><span style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">8️⃣ </span>What is the <strong>Interceptor</strong>?</p><p><span style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">9️⃣ </span>What is the purpose of <strong>Angular CLI</strong>?</p><p>🔟</p><pre data-language=\"plain\">\nthis.myForm.get(&#39;email&#39;)?.valueChanges.subscribe(\n        value =&gt; { console.log(&#39;Email changed:&#39;, value); }\n);\n</pre><p>How to <strong>optimize</strong> this when <strong>valueChanges</strong> fires on every <strong>keystroke</strong>?</p>"
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "noteType": "PracticeSet",
                            "topicId": 251,
                            "description": "<p>1️⃣ Why do we use <strong>trackBy</strong> in *<strong>ngFor</strong>?</p><p>2️⃣ How can we create <strong>custom Directive</strong>?</p><p>3️⃣ Explain <strong>Dependency Injection (DI)</strong> in <strong>Angular</strong>.</p><p>4️⃣ Why is <strong>constructor()</strong> called first in Angular?</p><p>5️⃣ How do you create a <strong>custom pipe</strong>?</p><p>6️⃣ What is the <strong>drawback</strong> of an <strong>AsyncPipe</strong>?</p><p>7️⃣ Create a <strong>registration form</strong> with fields: <strong>name</strong>, <strong>email</strong>, <strong>password</strong>, <strong>confirmPassword</strong> and apply <strong>required validations</strong> + <strong>password matching</strong> in <strong>Angular</strong>.</p><p>8️⃣ How does Angular’s <strong>change detection</strong> mechanism work?</p><p>9️⃣ How to <strong>test Service</strong> in <strong>Component</strong>?</p><p>🔟 How to <strong>test API</strong>?</p>"
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "noteType": "PracticeSet",
                            "topicId": 254,
                            "description": "<p>1️⃣ What is <strong>Generics</strong>? Show <strong>Angular HttpClient</strong> example.</p><p>2️⃣ What are <strong>decorators</strong>? Example: <strong>@Injectable</strong>, <strong>@Component</strong>?</p><p>3️⃣ What are <strong>tuple types</strong>?</p><p>4️⃣ What are <strong>Enums</strong> and where are they <strong>used</strong>?</p><p>5️⃣ What are <strong>semantic HTML tags</strong>? Give <strong>examples</strong>.</p><p>6️⃣ What is <strong>srcset</strong>?</p><p>7️⃣ How do you handle <strong>memory leaks</strong> with <strong>Observables</strong>?</p><p>8️⃣ What is the difference between <strong>tap</strong> and <strong>map</strong>?</p><p>9️⃣ Explain <strong>mergeMap</strong>, <strong>concatMap</strong>, <strong>switchMap</strong>, and <strong>forkJoin</strong>.</p><p>🔟 Explain <strong>NgRx Flow</strong> (<strong>Redux Pattern</strong> in Angular).</p>"
                        },
                        {
                    ...
                    "topics": [
                        {
                            ...
                            "noteType": "PracticeSet",
                            "topicId": 282,
                            "description": "<p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">1️⃣ What is difference between </span><strong style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">Observable </strong><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">and </span><strong style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">Signals</strong><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">?</span></p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">2️⃣ </span>Can you explain how<strong> dependency injection </strong>works?</p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">3️⃣ </span></p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">4️⃣ </span></p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">5️⃣ </span></p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">6️⃣ </span></p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">7️⃣ </span></p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">8️⃣ </span></p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">9️⃣ </span></p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">🔟 </span></p>"
                        }
                    ]
                }
            ]
