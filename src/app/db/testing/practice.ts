            ...
            "subSections": [
                {
                    ...
                    "topics": [
                        ...
                        },
                        {
                            ...
                            "noteType": "PracticeSet",
                            "topicId": 249,
                            "description": "<p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">1️⃣ </span>Can you tell me about <strong>last project</strong>?</p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">2️⃣ </span>How can you <strong>optimize Angular Application</strong> for <strong>better performance</strong>?</p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">3️⃣ </span>If on a <strong>button click</strong> I hit an <strong>API</strong> and the <strong>API takes 2 minutes</strong> and I keep clicking the button, then when I get a <strong>response</strong>, how can I <strong>cancel all other API calls</strong>?</p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">4️⃣ </span>What is the role of a <strong>compiler</strong> in <strong>Angular</strong>?</p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">5️⃣ </span>How do <strong>components communicate</strong> with each other in a <strong>large-scale Angular application</strong>?</p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">6️⃣ </span>Create a <strong>registration form</strong> with fields: <strong>name</strong>, <strong>email</strong>, <strong>password</strong>, and <strong>confirmPassword</strong>. Apply <strong>validations</strong> for <strong>required fields</strong>, and ensure <strong>password</strong> and <strong>confirmPassword match</strong>. How will you do it in <strong>Angular</strong>?</p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">7️⃣ </span>If I need to <strong>filter some item</strong> at every <strong>keystroke</strong> of user, how can we implement with <strong>Event binding approach</strong>?</p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">8️⃣ </span>What is the <strong>Interceptor</strong>?</p><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">9️⃣ </span>What is the purpose of <strong>Angular CLI</strong>?</p><pre data-language=\"plain\">\nthis.myForm.get(&#39;email&#39;)?.valueChanges.subscribe(\n        value =&gt; { console.log(&#39;Email changed:&#39;, value); }\n);\n</pre><p><span style=\"background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);\">🔟 </span>How to <strong>optimize</strong> this when <strong>valueChanges</strong> fires on every <strong>keystroke</strong>?</p>"
                        },
                        {
