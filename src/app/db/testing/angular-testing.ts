        ...
        },
        {
            ...
            "topics": [
                ...
                },
                {
                    ...
                    "noteType": "Angular",
                    "topicId": 245,
                    "description": "<p><strong>Event binding</strong> in Angular is a way to <strong>listen to DOM events</strong> (like <code>click</code>, <code>keyup</code>, <code>input</code>, <code>change</code>, etc.) and <strong>call a method in your component</strong> when that event happens.</p></br><p>I will use an <code>&lt;input type=&quot;text&quot;&gt;</code> element with the <code>(keyup)</code> event to listen for keyboard key releases. Every time the user types (presses and releases a key), Angular automatically calls the <code>filterList()</code> method and passes the event object (<code>$event</code>). I can then access the input value using <code>event.target.value</code>.</p></br><pre data-language=\"plain\">\nhtml\n\n&lt;input type=&quot;text&quot; (keyup)=&quot;filterList($event)&quot; placeholder=&quot;Search item...&quot; /&gt;\n&lt;ul&gt;\n  &lt;li *ngFor=&quot;let item of filteredItems&quot;&gt;{{ item }}&lt;/li&gt;\n&lt;/ul&gt;\n</pre></br><pre data-language=\"plain\">\nts\n\nfilterList(event: any) {\n  const value = event.target.value.toLowerCase();\n  this.filteredItems = this.items.filter(item =&gt;\n    item.toLowerCase().includes(value)\n  );\n}\n</pre>"
                },
                {
                ...
                },
                {
                    ...
                    "topics": [
                        ...
                        },
                        {
                            ...
                            "noteType": "Angular",
                            "topicId": 244,
                            "description": "<p>401 = not logged in or token invalid.</p></br><p>403 = logged in but access denied.</p></br>"
                        }
                    ]
                },
                {
