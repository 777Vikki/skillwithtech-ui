        ...
        },
        {
            ...
            "topics": [
                ...
                },
                {
                    ...
                    "noteType": "Angular",
                    "topicId": 12,
                    "description": "<p><strong>&#39;describe&#39;</strong> is a <strong>test suite</strong> (a <strong>folder</strong> or <strong>box</strong>) in <strong>Jasmine</strong>. It <strong>groups together related test cases</strong> (<strong>it blocks</strong>) and helps <strong>organize tests logically</strong>.</p></br><pre data-language=\"plain\">\nimport { TestBed } from &#39;@angular/core/testing&#39;;\nimport { AppComponent } from &#39;./app.component&#39;;\n\ndescribe(&#39;AppComponent&#39;, () =&gt; {\n  beforeEach(async () =&gt; {\n    await TestBed.configureTestingModule({\n      imports: [AppComponent ],\n    }).compileComponents();\n  });\n\n  it(&#39;should create the app&#39;, () =&gt; {\n    const fixture = TestBed.createComponent(AppComponent );\n    const component = fixture.componentInstance;\n    expect(component).toBeTruthy();\n  });\n});\n</pre>"
                },
                {
                ...
                },
                {
                    ...
                    "noteType": "Angular",
                    "topicId": 16,
                    "description": "<p>In <strong>Angular unit testing</strong>, the <strong>expect</strong> function <strong>verifies</strong> that the <strong>actual result</strong> matches the <strong>expected result</strong> using <strong>matchers</strong>.</p></br><p><strong>need to test &lt;h1&gt;Mayank&lt;/h1&gt;:</strong></p><pre data-language=\"plain\">\nit(&#39;should display &quot;Mayank&quot; inside h1 tag&#39;, () =&gt; {\n    const compiled = fixture.nativeElement as HTMLElement;\n    expect(compiled.querySelector(&#39;h1&#39;)?.textContent).toContain(&#39;Mayank&#39;); // ✅ test content\n  });\n</pre></br><p><strong>need to test &lt;h1&gt;Mayank&lt;/h1&gt; &lt;h1&gt;Praveen&lt;/h1&gt; &lt;h1&gt;Mohit&lt;/h1&gt;:</strong></p><pre data-language=\"plain\">\nit(&#39;should render three h1 tags&#39;, () =&gt; {\n    const h1Elements = compiled.querySelectorAll(&#39;h1&#39;);\n    expect(h1Elements.length).toBe(3);\n  });\n\n  it(&#39;should display correct names in h1 tags&#39;, () =&gt; {\n    const h1Elements = compiled.querySelectorAll(&#39;h1&#39;);\n    const names = Array.from(h1Elements).map(h1 =&gt; h1.textContent?.trim());\n    expect(names).toEqual([&#39;Mayank&#39;, &#39;Praveen&#39;, &#39;Mohit&#39;]);\n  });\n</pre></br><p><strong>need to test &lt;div class=&quot;user-name&quot;&gt;Mayank&lt;/div&gt; identify using class:</strong></p><pre data-language=\"plain\">\nit(&#39;should display correct user name using class selector&#39;, () =&gt; {\n    const userDiv = compiled.querySelector(&#39;.user-name&#39;);\n    expect(userDiv).toBeTruthy(); // ✅ element exists\n    expect(userDiv?.textContent?.trim()).toBe(&#39;Mayank&#39;); // ✅ text matches\n  });\n</pre></br><p><strong>Notes:</strong></p></br><p>By <strong>tag name:</strong></p><pre data-language=\"plain\">\nconst divElement = fixture.nativeElement.querySelector(&#39;div&#39;);\n</pre></br><p><strong>By class:</strong></p><pre data-language=\"plain\">\nconst userDiv = fixture.nativeElement.querySelector(&#39;.user-name&#39;);\n</pre></br><p><strong>By id:</strong></p><pre data-language=\"plain\">\nconst userDiv = fixture.nativeElement.querySelector(&#39;#user-name&#39;);\n</pre></br><p><code>querySelector</code> → returns <strong>first match</strong>.</p><p><code>querySelectorAll</code> → returns <strong>all matches</strong> as a NodeList (can convert to array if needed).</p><pre data-language=\"plain\">\n\n</pre>"
                },
                {
                ...
                {
                    "text": "<p>How can unit test HTTP?</p>",
                    "sectionId": 24,
                    "subSectionId": -1,
                    "noteType": "Angular",
                    "topicId": 234,
                    "description": "<pre data-language=\"plain\">\nuser.service.ts\n\nimport { Injectable } from &#39;@angular/core&#39;;\nimport { HttpClient } from &#39;@angular/common/http&#39;;\nimport { Observable } from &#39;rxjs&#39;;\n\n@Injectable({\n  providedIn: &#39;root&#39;\n})\nexport class UserService {\n  constructor(private http: HttpClient) {}\n\n  getUser(): Observable&lt;any&gt; {\n    return this.http.get(&#39;https://api.example.com/user&#39;);\n  }\n}\n</pre></br><pre data-language=\"plain\">\napp.component.ts\n\nimport { Component, OnInit } from &#39;@angular/core&#39;;\nimport { UserService } from &#39;./user.service&#39;;\n\n@Component({\n  selector: &#39;app-root&#39;,\n  template: `&lt;div class=&quot;user-name&quot;&gt;{{ user?.name }}&lt;/div&gt;\n             &lt;div class=&quot;user-age&quot;&gt;{{ user?.age }}&lt;/div&gt;`,\n  standalone: true\n})\nexport class AppComponent implements OnInit {\n  user: any;\n\n  constructor(private userService: UserService) {}\n\n  ngOnInit() {\n    this.userService.getUser().subscribe(data =&gt; this.user = data);\n  }\n}\n</pre></br><p><strong style=\"color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);\">Test with manual mock:</strong></p></br><pre data-language=\"plain\">\napp.component.spec.ts\n\nimport { TestBed } from &#39;@angular/core/testing&#39;;\nimport { AppComponent } from &#39;./app.component&#39;;\nimport { UserService } from &#39;./user.service&#39;;\nimport { of } from &#39;rxjs&#39;;\n\n// ✅ Manual Mock / Stub for UserService\nclass MockUserService {\n  getUser() {\n    return of({ name: &#39;Mayank&#39;, age: 25 }); // returns Observable like HttpClient\n  }\n}\n\ndescribe(&#39;AppComponent with HTTP Mock&#39;, () =&gt; {\n  let fixture: any;\n  let component: any;\n  let compiled: HTMLElement;\n\n  beforeEach(async () =&gt; {\n    await TestBed.configureTestingModule({\n      imports: [AppComponent],\n      providers: [\n        { provide: UserService, useClass: MockUserService } // inject mock\n      ]\n    }).compileComponents();\n\n    fixture = TestBed.createComponent(AppComponent);\n    component = fixture.componentInstance;\n    fixture.detectChanges(); // triggers ngOnInit\n    compiled = fixture.nativeElement;\n  });\n\n  it(&#39;should create the component&#39;, () =&gt; {\n    expect(component).toBeTruthy();\n  });\n\n  it(&#39;should get user data from mock service&#39;, () =&gt; {\n    expect(component.user.name).toBe(&#39;Mayank&#39;);\n    expect(component.user.age).toBe(25);\n  });\n\n  it(&#39;should display user data in template&#39;, () =&gt; {\n    const nameDiv = compiled.querySelector(&#39;.user-name&#39;);\n    const ageDiv = compiled.querySelector(&#39;.user-age&#39;);\n\n    expect(nameDiv?.textContent?.trim()).toBe(&#39;Mayank&#39;);\n    expect(ageDiv?.textContent?.trim()).toBe(&#39;25&#39;);\n  });\n});\n</pre></br><p><strong>Unit Test Using Jasmine Spy:</strong></p></br><pre data-language=\"plain\">\napp.component.spec.ts\n\nimport { TestBed } from &#39;@angular/core/testing&#39;;\nimport { of } from &#39;rxjs&#39;;\nimport { AppComponent } from &#39;./app.component&#39;;\nimport { UserService } from &#39;./user.service&#39;;\n\ndescribe(&#39;AppComponent with Jasmine Spy&#39;, () =&gt; {\n  let fixture: any;\n  let component: any;\n  let compiled: HTMLElement;\n  let userServiceSpy: jasmine.SpyObj&lt;UserService&gt;;\n\n  beforeEach(async () =&gt; {\n    // ✅ Create spy object for UserService\n    userServiceSpy = jasmine.createSpyObj(&#39;UserService&#39;, [&#39;getUser&#39;]);\n    // ✅ Define return value for getUser()\n    userServiceSpy.getUser.and.returnValue(of({ name: &#39;Mayank&#39;, age: 25 }));\n\n    await TestBed.configureTestingModule({\n      imports: [AppComponent],\n      providers: [\n        { provide: UserService, useValue: userServiceSpy } // inject spy\n      ]\n    }).compileComponents();\n\n    fixture = TestBed.createComponent(AppComponent);\n    component = fixture.componentInstance;\n    fixture.detectChanges(); // triggers ngOnInit\n    compiled = fixture.nativeElement;\n  });\n\n  it(&#39;should create the component&#39;, () =&gt; {\n    expect(component).toBeTruthy();\n  });\n\n  it(&#39;should call getUser from UserService&#39;, () =&gt; {\n    expect(userServiceSpy.getUser).toHaveBeenCalled(); // ✅ spy tracks method calls\n  });\n\n  it(&#39;should get user data from spy&#39;, () =&gt; {\n    expect(component.user.name).toBe(&#39;Mayank&#39;);\n    expect(component.user.age).toBe(25);\n  });\n\n  it(&#39;should display user data in template&#39;, () =&gt; {\n    const nameDiv = compiled.querySelector(&#39;.user-name&#39;);\n    const ageDiv = compiled.querySelector(&#39;.user-age&#39;);\n\n    expect(nameDiv?.textContent?.trim()).toBe(&#39;Mayank&#39;);\n    expect(ageDiv?.textContent?.trim()).toBe(&#39;25&#39;);\n  });\n});\n</pre></br><p><strong>Unit Test with </strong><code><strong>HttpClientTestingModule:</strong></code></p></br><pre data-language=\"plain\">\napp.component.spec.ts\n\nimport { TestBed } from &#39;@angular/core/testing&#39;;\nimport { HttpClientTestingModule, HttpTestingController } from &#39;@angular/common/http/testing&#39;;\nimport { AppComponent } from &#39;./app.component&#39;;\nimport { UserService } from &#39;./user.service&#39;;\n\ndescribe(&#39;AppComponent with HttpClientTestingModule&#39;, () =&gt; {\n  let fixture: any;\n  let component: any;\n  let compiled: HTMLElement;\n  let httpMock: HttpTestingController;\n  let userService: UserService;\n\n  beforeEach(async () =&gt; {\n    await TestBed.configureTestingModule({\n      imports: [AppComponent, HttpClientTestingModule],\n      providers: [UserService]\n    }).compileComponents();\n\n    fixture = TestBed.createComponent(AppComponent);\n    component = fixture.componentInstance;\n    compiled = fixture.nativeElement;\n\n    userService = TestBed.inject(UserService);\n    httpMock = TestBed.inject(HttpTestingController);\n\n    fixture.detectChanges(); // triggers ngOnInit\n  });\n\n  afterEach(() =&gt; {\n    httpMock.verify(); // ensures no pending HTTP requests\n  });\n\n  it(&#39;should create the component&#39;, () =&gt; {\n    expect(component).toBeTruthy();\n  });\n\n  it(&#39;should fetch user data from HTTP request&#39;, () =&gt; {\n    // ✅ Expect one HTTP GET request\n    const req = httpMock.expectOne(&#39;https://api.example.com/user&#39;);\n    expect(req.request.method).toBe(&#39;GET&#39;);\n\n    // ✅ Respond with mock data\n    req.flush({ name: &#39;Mayank&#39;, age: 25 });\n\n    // ✅ Verify component received the data\n    expect(component.user.name).toBe(&#39;Mayank&#39;);\n    expect(component.user.age).toBe(25);\n  });\n\n  it(&#39;should display user data in template&#39;, () =&gt; {\n    const req = httpMock.expectOne(&#39;https://api.example.com/user&#39;);\n    req.flush({ name: &#39;Mayank&#39;, age: 25 });\n    fixture.detectChanges();\n\n    const nameDiv = compiled.querySelector(&#39;.user-name&#39;);\n    const ageDiv = compiled.querySelector(&#39;.user-age&#39;);\n\n    expect(nameDiv?.textContent?.trim()).toBe(&#39;Mayank&#39;);\n    expect(ageDiv?.textContent?.trim()).toBe(&#39;25&#39;);\n  });\n});\n\n</pre><p><strong>Notes:</strong></p><p>Use <strong>Manual Mock / Spy</strong> for simple component/service logic.</p><p>Use <strong>HttpClientTestingModule</strong> whenever your service actually makes HTTP calls or you need to test request/response behavior.</p>"
                }
            ],
            "subSections": [
                {
            ...
            "subSections": [
                {
                    ...
                    "topics": [
                        ...
                        {
                            "text": "<p>What is different between before vs after standalone components?</p>",
                            "sectionId": 39,
                            "subSectionId": 10,
                            "noteType": "Angular",
                            "topicId": 235,
                            "description": "<p><strong>Before Standalone Components (Traditional Angular):</strong></p><p>Every component needed to be <strong>declared in an </strong><code><strong>NgModule</strong></code> (<code>declarations</code> array).</p><p>To use a component in another module, you had to:</p><ul><li>Declare it in a module</li><li>Export it</li><li>Import that module where you want to use it</li></ul></br><p><strong>After Standalone Components:</strong></p><p>A component can now be <strong>standalone</strong>, which means:</p><ul><li>It does <strong>not need a module</strong> to exist.</li><li>It can <strong>directly import its dependencies</strong> (like <code>CommonModule</code>, other components, directives, pipes).</li></ul></br><p><strong>1️⃣Bundle Size &amp; Tree-Shaking:</strong></p><ul><li><strong>Before (NgModule):</strong><ul><li>All components declared in a module are considered &quot;linked,&quot; even if some aren’t used.</li><li>Modules can unintentionally pull in unused components, directives, or pipes.</li><li>This can increase <strong>bundle size</strong> slightly.</li></ul></li><li><strong>After (Standalone Component):</strong><ul><li>Components import only the dependencies they need (<code>imports: [CommonModule, OtherComponent]</code>).</li><li>Angular compiler can <strong>tree-shake unused code more effectively</strong>.</li><li><strong>Result:</strong> Smaller final bundle → faster load time.</li></ul></li></ul></br><p>2️⃣ <strong>Bootstrapping / Startup Time</strong></p><ul><li><strong>Before:</strong><ul><li>App starts via <code>AppModule</code>.</li><li>Angular has to process all NgModules and their metadata before instantiating components.</li><li>Slight overhead, especially for large apps.</li></ul></li><li><strong>After:</strong><ul><li>App can bootstrap a <strong>standalone component directly</strong> (<code>bootstrapApplication(UserComponent)</code>).</li><li>Angular skips the NgModule resolution step.</li><li><strong>Result:</strong> Slightly faster <strong>initial startup</strong>.</li></ul></li></ul></br><p>3️⃣<strong> Lazy Loading</strong></p><ul><li><strong>Before:</strong><ul><li>Lazy loading usually happens at module level (<code>loadChildren</code>).</li><li>Can be more complex to manage because you have to create separate NgModules for each lazy route.</li></ul></li><li><strong>After:</strong><ul><li>Standalone components can be <strong>lazy-loaded directly</strong> in routes:</li></ul></li></ul>"
                        },
                        {
